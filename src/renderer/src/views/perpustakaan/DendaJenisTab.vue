                ...
                <div class="p-5">
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl">
                        <div>
                            ...
                            <input v-model="form.kode_denda" type="text" maxlength="20" class="input input-bordered w-full" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-base-content/80 mb-1.5">Jenis Denda <span class="text-error">*</span></label>
                            <input v-model="form.jenis_denda" type="text" maxlength="150" class="input input-bordered w-full" placeholder="Contoh: Buku Rusak" />
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-base-content/80 mb-1.5">% dari Harga Buku <span class="text-error">*</span></label>
                            <input v-model="form.besar_denda" type="number" min="0" max="100" class="input input-bordered w-full" @keyup.enter="simpan" />
                        </div>
                    </div>
    ...
    <dialog ref="modalEdit" class="modal">
        <div class="modal-box max-w-sm">
            ...
            <div class="space-y-3">
                <div>
                    <label class="block text-sm font-medium text-base-content/80 mb-1.5">Kode</label>
                    <input v-model="editForm.kode_denda" type="text" maxlength="20" class="input input-bordered w-full" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-base-content/80 mb-1.5">Jenis Denda</label>
                    <input v-model="editForm.jenis_denda" type="text" maxlength="150" class="input input-bordered w-full" />
                </div>
                <div>
                    <label class="block text-sm font-medium text-base-content/80 mb-1.5">% dari Harga Buku</label>
                    <input v-model="editForm.besar_denda" type="number" min="0" max="100" class="input input-bordered w-full" />
                </div>
            </div>
