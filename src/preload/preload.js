...
contextBridge.exposeInMainWorld('api', {
    ...
    ipsrs: {
        ...
        pengadaan: {
            listPetugas:  ()               => ipcRenderer.invoke('ipsrs:pengadaan:listPetugas'),
            nextNoFaktur: (tglBeli)         => ipcRenderer.invoke('ipsrs:pengadaan:nextNoFaktur', tglBeli),
            list:         (params)          => ipcRenderer.invoke('ipsrs:pengadaan:list', params),
            detail:       (noFaktur)        => ipcRenderer.invoke('ipsrs:pengadaan:detail', noFaktur),
            create:       (token, data)     => ipcRenderer.invoke('ipsrs:pengadaan:create', token, data),
        },
        pengeluaran: {
            listPetugas:        ()               => ipcRenderer.invoke('ipsrs:pengeluaran:listPetugas'),
            getFromPermintaan:  (noPermintaan)    => ipcRenderer.invoke('ipsrs:pengeluaran:getFromPermintaan', noPermintaan),
            nextNoKeluar:       (tanggal)         => ipcRenderer.invoke('ipsrs:pengeluaran:nextNoKeluar', tanggal),
            list:               (params)          => ipcRenderer.invoke('ipsrs:pengeluaran:list', params),
            detail:             (noKeluar)        => ipcRenderer.invoke('ipsrs:pengeluaran:detail', noKeluar),
            create:             (token, data)     => ipcRenderer.invoke('ipsrs:pengeluaran:create', token, data),
        },
        returBeli: {
            listPetugas:  ()               => ipcRenderer.invoke('ipsrs:returBeli:listPetugas'),
            nextNoRetur:  (tanggal)         => ipcRenderer.invoke('ipsrs:returBeli:nextNoRetur', tanggal),
            list:         (params)          => ipcRenderer.invoke('ipsrs:returBeli:list', params),
            detail:       (noReturBeli)     => ipcRenderer.invoke('ipsrs:returBeli:detail', noReturBeli),
            create:       (token, data)     => ipcRenderer.invoke('ipsrs:returBeli:create', token, data),
        },
        laporan: {
    ...
    keuangan: {
        ...
        jurnalHarian: {
            list: (token, params) => ipcRenderer.invoke('keuangan:jurnalHarian:list', token, params),
        ...
        masterAkun: {
            ...
            updateBayar: (token, oldNama, data) => ipcRenderer.invoke('keuangan:masterAkun:updateBayar', token, oldNama, data),
            ...
            updatePiutang: (token, oldNama, data) => ipcRenderer.invoke('keuangan:masterAkun:updatePiutang', token, oldNama, data),
            ...
            updateBayarHutang: (token, oldNama, data) => ipcRenderer.invoke('keuangan:masterAkun:updateBayarHutang', token, oldNama, data),
            ...
            updateAset: (token, oldIdJenis, data) => ipcRenderer.invoke('keuangan:masterAkun:updateAset', token, oldIdJenis, data),
            ...
            updateKategoriPemasukan: (token, oldKode, data) => ipcRenderer.invoke('keuangan:masterAkun:updateKategoriPemasukan', token, oldKode, data),
            deleteKategoriPemasukan: (token, kode) => ipcRenderer.invoke('keuangan:masterAkun:deleteKategoriPemasukan', token, kode),
            listPenagihanPiutang: () => ipcRenderer.invoke('keuangan:masterAkun:listPenagihanPiutang'),
            createPenagihanPiutang: (token, data) => ipcRenderer.invoke('keuangan:masterAkun:createPenagihanPiutang', token, data),
            updatePenagihanPiutang: (token, oldKdRek, data) => ipcRenderer.invoke('keuangan:masterAkun:updatePenagihanPiutang', token, oldKdRek, data),
            deletePenagihanPiutang: (token, kode) => ipcRenderer.invoke('keuangan:masterAkun:deletePenagihanPiutang', token, kode),
        }
    },
