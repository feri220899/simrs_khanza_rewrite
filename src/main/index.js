...
import SuratTaksonomiService from './db/modules/surat/SuratTaksonomiService.js'
import PerpustakaanTaksonomiService from './db/modules/perpustakaan/PerpustakaanTaksonomiService.js'
import PerpustakaanPenerbitService  from './db/modules/perpustakaan/PerpustakaanPenerbitService.js'
import PerpustakaanKoleksiService   from './db/modules/perpustakaan/PerpustakaanKoleksiService.js'
import PerpustakaanAnggotaService   from './db/modules/perpustakaan/PerpustakaanAnggotaService.js'
import PerpustakaanInventarisService from './db/modules/perpustakaan/PerpustakaanInventarisService.js'
import PerpustakaanSirkulasiService from './db/modules/perpustakaan/PerpustakaanSirkulasiService.js'
import PerpustakaanDendaService     from './db/modules/perpustakaan/PerpustakaanDendaService.js'
import PerpustakaanBayarDendaService from './db/modules/perpustakaan/PerpustakaanBayarDendaService.js'
import PerpustakaanPengaturanService from './db/modules/perpustakaan/PerpustakaanPengaturanService.js'
import SuratMasukKeluarService from './db/modules/surat/SuratMasukKeluarService.js'
import LaporanRlService from './db/modules/LaporanRlService.js'
import EEksekutifService from './db/modules/eeksekutif/EEksekutifService.js'
import EEksekutifNonMedisService from './db/modules/eeksekutif/EEksekutifNonMedisService.js'
import EEksekutifDapurService from './db/modules/eeksekutif/EEksekutifDapurService.js'
import EEksekutifMutuService from './db/modules/eeksekutif/EEksekutifMutuService.js'
import EEksekutifKasirService from './db/modules/eeksekutif/EEksekutifKasirService.js'
import EEksekutifAkuntansiService from './db/modules/eeksekutif/EEksekutifAkuntansiService.js'
import MinioService from './electron/MinioService.js'
import CacheService from './electron/CacheService.js'
import TokoJenisService from './db/modules/toko/TokoJenisService.js'
import TokoSuplierService from './db/modules/toko/TokoSuplierService.js'
import TokoMemberService from './db/modules/toko/TokoMemberService.js'
import TokoBarangService from './db/modules/toko/TokoBarangService.js'
import TokoOpnameService from './db/modules/toko/TokoOpnameService.js'
import SatuanService from './db/modules/SatuanService.js'
import IpsrsJenisService from './db/modules/ipsrs/IpsrsJenisService.js'
import IpsrsSuplierService from './db/modules/ipsrs/IpsrsSuplierService.js'
import IpsrsBarangService from './db/modules/ipsrs/IpsrsBarangService.js'
import IpsrsRiwayatService from './db/modules/ipsrs/IpsrsRiwayatService.js'
import IpsrsStokService from './db/modules/ipsrs/IpsrsStokService.js'
import IpsrsPermintaanService from './db/modules/ipsrs/IpsrsPermintaanService.js'
import IpsrsLaporanService from './db/modules/ipsrs/IpsrsLaporanService.js'
import IpsrsPengajuanService from './db/modules/ipsrs/IpsrsPengajuanService.js'
import IpsrsSuratPemesananService from './db/modules/ipsrs/IpsrsSuratPemesananService.js'
...
import KeuanganMatrixAkunPerawatanService from './db/modules/keuangan/KeuanganMatrixAkunPerawatanService.js'
import KeuanganMasterAkunService from './db/modules/keuangan/KeuanganMasterAkunService.js'
import KeuanganJurnalService from './db/modules/keuangan/KeuanganJurnalService.js'
import KeuanganJurnalHarianService from './db/modules/keuangan/KeuanganJurnalHarianService.js'
import KeuanganBukuBesarService from './db/modules/keuangan/KeuanganBukuBesarService.js'
import KeuanganLabaRugiService from './db/modules/keuangan/KeuanganLabaRugiService.js'
import KeuanganCashflowService from './db/modules/keuangan/KeuanganCashflowService.js'
import KeuanganKategoriPengeluaranService from './db/modules/keuangan/KeuanganKategoriPengeluaranService.js'
import KeuanganPengeluaranHarianService from './db/modules/keuangan/KeuanganPengeluaranHarianService.js'
import KeuanganPemasukanLainService from './db/modules/keuangan/KeuanganPemasukanLainService.js'
...
app.whenReady().then(async () => {
    ...
    handle('keuangan:cashflow:get', (_, token, params) => {
